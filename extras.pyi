...
class ReplicationCursor(_replicationCursor):
    def create_replication_slot(self, slot_name: Any, slot_type: Optional[Any] = ..., output_plugin: Optional[Any] = ...) -> None: ...
    def drop_replication_slot(self, slot_name: Any) -> None: ...
    def start_replication(self, slot_name: Optional[Any] = ..., slot_type: Optional[Any] = ..., start_lsn: int = ..., timeline: int = ..., options: Optional[Any] = ..., decode: bool = ...) -> None: ...
    def fileno(self): ...
...
def register_hstore(conn_or_curs: Any, globally: bool = ..., str: bool = ..., oid: Optional[Any] = ..., array_oid: Optional[Any] = ...) -> None: ...
